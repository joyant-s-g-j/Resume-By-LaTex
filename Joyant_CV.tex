...
\section{\textbf{References}}
    ...
    \item \small{
        ...
        Email:  \\
        LinkedIn:  \\
        \textit{"Joyant's technical expertise is truly outstanding. He consistently delivers high-quality solutions efficiently and on time, making him a highly reliable and valuable member of any development team. His strong work ethic, problem-solving abilities, and eagerness to learn new technologies set him apart. Moreover, Joyant collaborates effectively with team members and adapts quickly to challenges, demonstrating both professionalism and dedication throughout his work."}
    }
    \vspace{5pt}
    \item \small{
        \textbf{Anup Saha} \\
        ...
        Email:  \\
        LinkedIn:  \\
        \textit{"Joyant is a highly skilled developer with a keen eye for detail. His methodical and structured approach to work, combined with consistent and reliable performance, makes him an invaluable contributor to any development project. He approaches challenges thoughtfully and ensures quality in every task he undertakes, which greatly benefits the entire team."}
    }
    \end{itemize}
