...
\section{\textbf{Leadership \& Volunteer Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Represented Phitron to promote tech education and coding culture on campus}
        \resumeItem{Organized workshops and peer learning sessions to build a strong community}
        \resumeItem{Participated in monthly tech upskilling events and networking opportunities}
        \resumeItem{Contributed to LinkedIn branding while preparing for internship and certification opportunities}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
